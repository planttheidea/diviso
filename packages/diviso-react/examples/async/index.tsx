...
import { createStore, part } from 'diviso';
import { Provider, usePart, usePartUpdate, usePartValue } from 'diviso-react';
...
const store = createStore({ parts: [postPart] as const });
