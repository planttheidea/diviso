...
import type { AnyStatefulPart, CombinedPartsState } from './part.mjs';
import type { Dispatch, GetState, GetVersion, Notifier, PartMap, Store, StoreEnhancer, StoreEnhancerStoreCreator, SubscribeToPart } from './store.mjs';
export interface EnhancerConfig {
    notifier: Notifier;
    partMap: PartMap;
}
export type Enhancer<Parts extends readonly AnyStatefulPart[], DispatchableAction extends Action = AnyAction> = StoreEnhancer<PartsStoreExtensions<CombinedPartsState<Parts>, DispatchableAction>>;
export type EnhancerStoreCreator<Parts extends readonly AnyStatefulPart[], DispatchableAction extends Action = AnyAction> = StoreEnhancerStoreCreator<PartsStoreExtensions<CombinedPartsState<Parts>, DispatchableAction>>;
export interface PartsStoreExtensions<State = any, DispatchableAction extends Action = AnyAction> {
    /**
...
export declare function createEnhancer<Parts extends readonly AnyStatefulPart[], DispatchableAction extends Action = AnyAction>({ notifier, partMap }: EnhancerConfig): Enhancer<Parts, DispatchableAction>;
