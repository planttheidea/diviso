(function(global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("redux-thunk")) : typeof define === "function" && define.amd ? define([ "exports", "redux-thunk" ], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, 
    factory(global.diviso = {}, global.reduxThunk));
})(this, (function(exports, thunkMiddleware) {
    "use strict";
    function compose() {
    ...
    function createEnhancer(_ref) {
        var notifier = _ref.notifier, partMap = _ref.partMap;
    ...
    function createReducer(_ref) {
        var otherReducer = _ref.otherReducer, partMap = _ref.partMap, parts = _ref.parts;
        var partsReducer = function partsReducer(state, action) {
            ...
            return is(prev, next) ? state : _extends({}, state, (_extends2 = {}, _extends2[owner] = next, 
            _extends2));
        };
        if (!otherReducer) {
            return function reducer(state, action) {
    ...
    function createStore(options) {
        var _ref2 = options || {}, _ref2$devTools = _ref2.devTools, devTools = _ref2$devTools === void 0 ? true : _ref2$devTools, enhancers = _ref2.enhancers, _ref2$middleware = _ref2.middleware, middleware = _ref2$middleware === void 0 ? [ thunkMiddleware ] : _ref2$middleware, _ref2$notifier = _ref2.notifier, notifier = _ref2$notifier === void 0 ? defaultNotifier : _ref2$notifier, otherReducer = _ref2.otherReducer, parts = _ref2.parts, preloadedState = _ref2.preloadedState;
    ...
    function createComposedReducer(part) {
        var initialState = part.i, name = part.o, originalReducer = part.r;
        return function reduce(state, action) {
            ...
            return is(prevState, nextState) ? state : _extends({}, state, (_extends2 = {}, _extends2[name] = nextState, 
            _extends2));
        };
    }
    ...
    function createComposedPart(config) {
        var name = config.name, parts = config.parts;
    ...
    function createPrimitivePart(config) {
        var initialState = config.initialState, name = config.name;
        var part = function actionCreator(nextValue) {
            return {
                $$part: part.id,
                type: part.t,
    ...
    function createBoundSelectPart(config) {
        var get = config.get, _config$isEqual = config.isEqual, isEqual = _config$isEqual === void 0 ? is : _config$isEqual, parts = config.parts;
    ...
    function createUnboundSelectPart(config) {
        var get = config.get, _config$isEqual2 = config.isEqual, isEqual = _config$isEqual2 === void 0 ? is : _config$isEqual2;
    ...
    function createBoundProxyPart(config) {
        var get = config.get, _config$isEqual3 = config.isEqual, isEqual = _config$isEqual3 === void 0 ? is : _config$isEqual3, parts = config.parts, set = config.set;
        var select = createBoundSelector(parts, get, isEqual);
    ...
    function createUnboundProxyPart(config) {
        var get = config.get, _config$isEqual4 = config.isEqual, isEqual = _config$isEqual4 === void 0 ? is : _config$isEqual4, set = config.set;
        var select = createUnboundSelector(get, isEqual);
        var update = createUpdate(set);
        var part = {};
        part.id = getId();
